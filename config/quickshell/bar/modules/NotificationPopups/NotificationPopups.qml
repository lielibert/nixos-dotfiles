...
PanelWindow {
    ...
    readonly property color m3Surface: Qt.rgba((pywal?.background ?? Qt.rgba(0.12, 0.12, 0.14, 1)).r, (pywal?.background ?? Qt.rgba(0.12, 0.12, 0.14, 1)).g, (pywal?.background ?? Qt.rgba(0.12, 0.12, 0.14, 1)).b, 0.95)
            ...
            Item {
                ...
                Item {
                    ...
                    Rectangle {
                        ...
                        opacity: Math.min(0.8, Math.abs(notifCard.dragX) / (config.notifications.popupWidth * popups.swipeThreshold * 1.5))

                        color: notifCard.dragX > 0 ? Qt.rgba(popups.m3Error.r, root.m3Error.g, root.m3Error.b, 0.08) : Qt.rgba(root.m3Primary.r, root.m3Primary.g, root.m3Primary.b, 0.08)
                        ...
                        Text {
                            ...
                            font.pixelSize: 24
                            color: notifCard.dragX > 0 ? popups.m3Error : root.m3Primary
                            opacity: 0.7
                        }
                    }
                    ...
                    Rectangle {
                        ...
                        color: popups.m3Surface
                        border.width: 1
                        border.color: notifCard.isHovered ? Qt.rgba(popups.m3Primary.r, root.m3Primary.g, root.m3Primary.b, 0.15) : root.m3Border
                        ...
                        Rectangle {
                            ...
                            color: modelData.urgency === 2 ? popups.m3Error : root.m3Warning
                        ...
                        Rectangle {
                            ...
                            height: 2
                            radius: 1
                            color: Qt.rgba(popups.m3OnSurface.r, root.m3OnSurface.g, root.m3OnSurface.b, 0.06)
                            clip: true
                            ...
                            Rectangle {
                                ...
                                color: Qt.rgba(popups.m3Primary.r, root.m3Primary.g, root.m3Primary.b, 0.5)
                                ...
                                NumberAnimation on width {
                                    ...
                                    onFinished: if (notifCard.isVisible)
                                        notifCard.dismiss()
                                }
                            }
                        }
                        ...
                        MouseArea {
                            ...
                            onWheel: wheel => {
                                ...
                                if (Math.abs(wheel.angleDelta.x) > Math.abs(wheel.angleDelta.y)) {
                                    ...
                                    const threshold = config.notifications.popupWidth * popups.swipeThreshold;
                        ...
                        ColumnLayout {
                            ...
                            RowLayout {
                                ...
                                ColumnLayout {
                                    ...
                                    Text {
                                        ...
                                        color: popups.m3OnSurfaceVariant
                                        Layout.fillWidth: true
                                    ...
                                    Text {
                                        ...
                                        color: Qt.rgba(popups.m3OnSurface.r, root.m3OnSurface.g, root.m3OnSurface.b, 0.35)
                                    }
                                }
                                ...
                                Rectangle {
                                    ...
                                    radius: 14
                                    color: closeMouseArea.pressed ? Qt.rgba(popups.m3Error.r, root.m3Error.g, root.m3Error.b, 0.15) : closeMouseArea.containsMouse ? Qt.rgba(root.m3OnSurface.r, root.m3OnSurface.g, root.m3OnSurface.b, 0.06) : "transparent"
                                    ...
                                    Text {
                                        ...
                                        font.family: "Material Design Icons"
                                        font.pixelSize: 14
                                        color: closeMouseArea.containsMouse ? popups.m3Error : Qt.rgba(root.m3OnSurface.r, root.m3OnSurface.g, root.m3OnSurface.b, 0.4)
                            ...
                            Item {
                                ...
                                Rectangle {
                                    ...
                                    radius: 14
                                    clip: true
                                    color: popups.m3SurfaceContainer
                                    border.width: 1
                                    border.color: popups.m3Border
                            ...
                            Flow {
                                ...
                                Repeater {
                                    ...
                                    Rectangle {
                                        ...
                                        // Subtle pill styling
                                        color: actionMouse.pressed ? Qt.rgba(popups.m3Primary.r, root.m3Primary.g, root.m3Primary.b, 0.25) : actionMouse.containsMouse ? Qt.rgba(root.m3Primary.r, root.m3Primary.g, root.m3Primary.b, 0.15) : Qt.rgba(root.m3Primary.r, root.m3Primary.g, root.m3Primary.b, 0.08)
